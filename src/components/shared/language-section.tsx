        ...
        <Section size={"screen"} className={formateClasses("bg-white", className)}>
            <Section.Inner className="relative">
                <div className="" dir="ltr">
                    ...
                    <div className="absolute scale-75 md:scale-90 lg:scale-100 bottom-0 md:bottom-4 lg:bottom-0 start-[85%] md:start-[82%] lg:start-[80%] -translate-x-1/2 -translate-y-1/2 min-[400px]:flex flex-col hidden">
                        <LanguageArrowIcon
